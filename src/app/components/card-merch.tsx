...
const CardMerch: React.FC<IPropsCardMerch> = ({ item }) => {
    return (
        <article key={item.id} className="p-5 bg-white w-full md:w-11/12 lg:h-autp aspect-square" >
            <Image src={item.image} alt="card-photo" width={200} height={200} className="w-full object-cover cursor-pointeraspect-square" />

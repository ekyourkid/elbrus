    ...
    return (
        <main className="bg-[#F5F4F4] flex flex-col-reverse justify-between md:flex-col-reverse lg:flex-row p-5 md:p-10 lg:space-x-40">
            ...
            <div className="basis-1/2">
                <h1 className="text-xl font-bold sm:text-2xl md:text-2xl w-40 mb-5 lg:hidden cursor-pointer">
                    ACTIVITY REPORT <span className="text-red-600">.</span>
                </h1>
                <Image src={'/images/manjat.png'} alt="climbing" width={621} height={621} className="object-cover w-full h-full max-w-96 cursor-pointer " />
            </div>
        </main>
    )
}
